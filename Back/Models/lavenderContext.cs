...
{
    public class lavenderContext : DbContext
    {
        ...
        public lavenderContext(DbContextOptions<lavenderContext> options, IWebHostEnvironment env)
            : base(options)
        {
            this.env = env;
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                var connectionStrings = configuration.GetSection("ConnectionStrings:AppMvcConnectionString").Value;
